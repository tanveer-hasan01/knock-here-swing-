...
public class SettingW extends javax.swing.JFrame {
   ...
   public SettingW() {
    ...
    public SettingW(String username)
    {
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(265, 161, 140, 50);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         setVisible(false);
                  ...
                  new DeleteW(usname).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SettingW.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
