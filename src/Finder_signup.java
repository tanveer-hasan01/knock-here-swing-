...
public class Finder_signup extends javax.swing.JFrame {

     Connection conn;
    ResultSet rs;
    PreparedStatement pst;
    
    public Finder_signup(){
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/knocking.png"))); // NOI18N
        ...
        jLabel9.setText("Sign up as a Finder ");

        jLabel10.setText("The name of your first phone number");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        
        {
            ...
            String pass=jTextField3.getText();
             String confirm_pass=jTextField4.getText();
            ...
            String sql= "Insert into FINDER_INFO (name,username,password,phone,email,security_qus,location) values(?,?,?,?,?,?,?)";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Finder_signup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Finder_signup().setVisible(true);
            }
        });
    }
