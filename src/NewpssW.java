 ...
 * @author cse92
 */
public class NewpssW extends javax.swing.JFrame {
    ...
    public NewpssW(String username)
    {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextField1.getText().isEmpty()||jTextField2.getText().isEmpty())
        {
             ...
             JOptionPane.showMessageDialog(null, "Type your new password");
            ...
            if(pass.equals(conpass))
            {
              ...
              String sql = "update Writer_info set password=? where username= ?";
           try
           {
            ...
            setVisible(false);
                    writer_login obj1= new writer_login();
